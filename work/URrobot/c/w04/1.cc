...
int main()
{
	...
	char movel2[1024]="movel(p[0.15, -0.47, 0.13, 3.14165, 0., 0.])\n";
	char movel3[1024]="movel(p[0.15, -0.27, 0.13, 3.14165, 0., 0.])\n";
    char movel4[1024]="movel(p[0, -0.27, 0.13, 3.14165, 0., 0.])\n";

	send(sock, movel, sizeof(movel),0);
	sleep(2);
	send(sock1, movel1, sizeof(movel1),0);
    sleep(2);
    send(sock2, movel2, sizeof(movel2),0);
    sleep(2);
	send(sock3, movel3, sizeof(movel3),0);
    sleep(2);
    send(sock4, movel4, sizeof(movel4),0);
